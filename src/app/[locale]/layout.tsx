...
const seoData: Record<Locale, {
  ...
  ru: {
    title: "FORMĒ — Премиальный женский фитнес-клуб в Алматы | Персональные тренировки",
  ...
  kk: {
    title: "FORMĒ — Алматыдағы премиум әйелдер фитнес-клубы | Жеке жаттығулар",
  ...
  en: {
    title: "FORMĒ — Premium Women's Fitness Club in Almaty | Personal Training",
...
export async function generateMetadata({
  ...
  return {
    ...
    authors: [{ name: "FORMĒ", url: "https://forme.kz" }],
    creator: "FORMĒ",
    publisher: "FORMĒ",
    formatDetection: {
      email: true,
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: locale === 'ru' ? "FORMĒ — Премиальный женский фитнес-клуб" : locale === 'kk' ? "FORMĒ — Премиум әйелдер фитнес-клубы" : "FORMĒ — Premium Women's Fitness Club",
        },
      ],
    },
    twitter: {
...
function getJsonLd(locale: Locale) {
  const names: Record<Locale, string> = {
    ru: "FORMĒ — Премиальный женский фитнес-клуб",
    kk: "FORMĒ — Премиум әйелдер фитнес-клубы",
    en: "FORMĒ — Premium Women's Fitness Club",
  };
